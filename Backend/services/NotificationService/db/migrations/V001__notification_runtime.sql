...
CREATE TABLE IF NOT EXISTS notification_delivery_dlq (
    id BIGSERIAL PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_notification_delivery_dlq_notification_id
    ON notification_delivery_dlq(notification_id);
CREATE INDEX IF NOT EXISTS idx_notification_delivery_dlq_failed_at
